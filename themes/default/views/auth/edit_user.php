        ...
        <div class="modal-content">
            ...
            <form action="<?php echo $target; ?>" method="post">
                ...
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo $title; ?> <?php echo $profile_id[value];?></h5>
                                     ...
                                     <select  id="profile_id" name="profile_id" class="editable-select">
                                                  <option value="-1" selected>Select Name</option>
                                                    <?php foreach ($names as $name):
                                                        echo '<option  id="' . $name->id . '" value="' . $name->id . '" ' . (isset($profile_id) && $profile_id[value] == $name->id ? 'selected' : '') . '>' . $name->vendor . '</option>';
                                                    endforeach; ?>
                                     </select>
								    </span>
                                    </div>
