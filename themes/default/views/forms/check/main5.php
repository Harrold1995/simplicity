<div class="modal flexmodal fade check-modal formGrid " id="checkModal" tabindex="-1" role="dialog" main-id=<?= isset($checks) && isset($checks->id) ? $checks->id : '-1' ?> type="check" aria-hidden="true" ref-id="<?= isset($header) && isset($header->transaction_ref) ? $header->transaction_ref : '' ?>">
