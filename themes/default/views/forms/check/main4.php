<div class="modal flexmodal fade check-modal formGrid " id="checkModal" tabindex="-1" role="dialog" main-id=<?= isset($checks) && isset($checks->id) ? $checks->id : '-1' ?> type="check" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl " role="document">
                  ...
                  <header class="modal-h">
					...
					<nav >
						<ul>
							...
							<li id="checkButtonClicked"><a class="" href="!#"><i class="icon-print" onclick ="checkprint($(this).closest('#checkModal'))"></i> <span>Print</span></a></li>
							<li><span class="buttons" style=""><span class="min" style="border-left: 1px solid #ccc;padding: 8px 20px;cursor: pointer;">_</span><span class="max" style="border-left: 1px solid #ccc;padding: 8px 20px;cursor: pointer;">[ ]</span><span class="close" style="border-left: 1px solid #ccc;padding: 8px 20px;cursor: pointer;">X</span></span>
				 </li>
						</ul>
					</nav>
					
				</header>
                <section class="a modalContent" style="padding-right:50px;">
                    ...
                    <div class="has-table-c modalContent">
        ...
        <footer>
          <ul class="list-btn modalContent">
