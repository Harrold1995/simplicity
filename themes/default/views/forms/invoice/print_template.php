...
#invoice tr{
   ...
   <?php if(isset($invoice))
                            ...
                            <div  class="page-break"> 
                                <div id="invoice" style="width: 800px; display: block; page-break-before: always; position: relative;">
                                    <div id="invoice-header" style="background-color: #efc100; color: #ffffff; height: 90px; display: flex; flex-direction: row; justify-content: space-around;" class="flex-container invoice-header">
                                            ...
                                            <!--<div id="invoiceDetails2">-->
                                                <div id="billedTo2" class="flex-container" style="padding-top: 30px; padding-bottom: 30px; display: flex; flex-direction: row; justify-content: space-around;">
