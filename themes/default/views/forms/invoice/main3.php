<div class="modal fade invoice-modal" id="invoice" tabindex="-1" role="dialog"  type="invoice" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
		  <div id="root" class="no-print">
            <div class="modal-content text-primary popup-a form-entry shown" style=" width: 850px;  padding: 30px;">
				  ...
				  <form action="<?php echo $target; ?>" method="post" class=" ve form-bills" data-title="invoice-entry" type=" memorized-transactions">
                        ...
                        <button type="" id="printThisInvoice">Print</button>
                        <button data-id="<?php echo $info->id ?>" type="<?php echo $info->type ?>" id="emailThisInvoice">Email</button>
                        <p class="submit"><button type="button" id="exit">Exit</button></p>
                        <div>
                           <p style="margin-right: 12px;">Start Date  <input data-toggle="datepicker" class="leaveEmpty statement-date" value="" id="start_date" data-id="<?php echo $info->id ?>" type="<?php echo $info->type ?>"> </p>
                           <p style="margin-right: 12px;">As of  <input data-toggle="datepicker" class ="statement-date" value="" id="as_of_date" data-id="<?php echo $info->id ?>" type="<?php echo $info->type ?>"> </p>
                        ...
                        $invoiceNumber = 1;
                            foreach($invoices as $invoice){
                               ...
                               <div invoice-id="<?= $info->id?>" invoice-profile-id="<?= $invoice->profile_id?>" class="page-break statements"> 
                                <div id="invoice" invoice-profile-id="<?= $invoice->profile_id?>" style="height:930px; padding-top: 15px; width: 775px; display: block; page-break-after: always; position: relative; font-family: HelveticaNeue,'Helvetica Neue',helvetica,Arial,sans-serif;">                                
                                    <div id="invoice-header" style=" background-color: #ffffff; color: #828080; height: 110px; " class="flex-container invoice-header">
