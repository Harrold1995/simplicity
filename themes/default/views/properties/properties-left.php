...
<form action="./" method="post" class="form-search double">
    <ul class="list-square">
        ...
        <li class="a"><a id="addPropertyButton" href="#addProperty"><i class="icon-plus"></i> <span>Add</span></a></li>
    ...
    <p>
        ...
        <a href="#"><i id="printIdC" class="icon-microphone"></i> <span>Record</span></a>
    </p>
...
<ul class="list-bottom">
    <li class="active"><a href="#properties" type="property"><i class="icon-city"></i> <span>Users</span></a></li>
...
<!--/aside-->
<script>
    $("#printIdC").click(function () {
        printPart();
    })
    $("#exportocsvC").click(function () {
