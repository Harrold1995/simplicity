<div class="maintenance-page table-b-wrapper">
	...
	<div class="table-f-wrapper vtab div1">
		<div class="rightslick-tablepm rightslick" style = 'padding:15px;'></div>
	</div>
</div>
...
<script>
	$(document).ready( async function () {
		let slickrender = new Promise(function(resolve, reject) {
			var slick = new SlickMaintenance('.rightslick-tablepm', {nofilter:true, dataUrl: "maintenance/getTickets?property_id=<?php echo $property->id?>"});
			resolve(slick);
		})
