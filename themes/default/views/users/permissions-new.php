                                        ...
                                        foreach($options as $o) {
                                            ...
                                            if(in_array($o, $p['options'])) 
                                                echo'<div class="custom-control custom-checkbox form-group p-standard">
                                                        <input type="checkbox" value="1" class="custom-control-input" '.(in_array($p['key'].'_'.$o, $permissions) ? 'checked' : '').' name="'.$p['key'].'_'.$o.'" id="name">
                                        ...
                                        foreach($p['data'] as $d) {
                                            ...
                                            foreach($options as $o) {
                                                ...
                                                if(in_array($o, $d['options'])) 
                                                    echo'<div class="custom-control custom-checkbox form-group p-standard">
                                                            <input type="checkbox" value="1" class="custom-control-input" '.(in_array($d['key'].'_'.$o, $permissions) ? 'checked' : '').' name="'.$d['key'].'_'.$o.'" id="name">
                                                            <label class="custom-control-label p-standard-label" for="name"></label>
                                                        </div>';
                                                echo'</td>';
                                            }                                        
