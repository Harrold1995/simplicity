                ...
                <table class="table-b" id="DataTables_Table_4" role="grid" aria-describedby="DataTables_Table_4_info">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo lang('index_permissions_th'); ?></th>
                    ...
                    <tbody>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($user->first_name1, ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($user->last_name1, ENT_QUOTES, 'UTF-8'); ?></td>
                                ...
                                <td><?php echo '<a href="#" data-type="custom" url="users/change_user_permissions/' . $user->id . '" data-id="' . $user->id . '" data-mode="edit">Change</a>'; ?></td>
                                <td>
                    ...
                    <tbody>
                        <?php foreach ($groups as $group): ?>
                            <tr>
                                ...
                                <td><?php echo '<a href="#" data-type="custom" url="users/change_permissions/' . $group->id . '" data-id="' . $group->id . '" data-mode="edit">Change</a>'; ?></td>
...
<aside class="left-side" style="opacity: 1;">
    <table class="tree-table" style="opacity: 1;">
        ...
        <tr <?=($page=='ltemplates')?' class="on" ':''?>><td id="recordsets_button"><a id="recordsets" href="<?=base_url('/recordsets')?>">recordsets</a></td></tr>
